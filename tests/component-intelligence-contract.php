...
foreach ( [ 'metadata_shortlist_count', 'structural_fit', 'design_compatibility', 'responsive_confidence', 'dependency_safety', 'edit_efficiency', 'estimated_normalization_cost' ] as $needle ) {
