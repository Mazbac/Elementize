...
assert_true_creative( false !== strpos( $design_source, "'palette_fallback_priority' => 'custom_before_system'" ), 'Sparse page palette fallback must prioritize site custom Kit tokens before generic Elementor system defaults.' );
