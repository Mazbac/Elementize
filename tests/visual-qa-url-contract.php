...
foreach ( [
    ...
    "private const JOB_PREFIX = 'elementize_visual_qa_job_v7_'",
    'Start-Process -FilePath',
    "getenv( 'ComSpec' )",
] as $needle ) {
    if ( false === strpos( $source, $needle ) ) fail_visual_qa_url_contract( 'Missing Visual QA v7 safety/launcher marker: ' . $needle );
}
