...
5. Treat dominant imagery as a hard selection criterion. Important photos/mockups must be positively relevant to the page topic/message. If relevance is uncertain and no verified replacement exists, reject that candidate and prefer neutral, icon/text-led, or clearly relevant alternatives.
